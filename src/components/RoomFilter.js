        ...
        <section className="filter-container">
            ...
            <form className="filter-form">
                ...
                <div className="form-group">
                    ...
                    <select name="type" it="type" value={type} className="form-control" onChange={handleChange}>
                        {types}
                    </select>
                </div>
                ...
                <div className="form-group">
                    ...
                    <select name="capacity" it="capacity" value={capacity} className="form-control" onChange={handleChange}>
                        {people}
                    </select>
                </div>
                {/* end guests */}
